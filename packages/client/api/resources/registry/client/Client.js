  ...
  async getS3UrlForLibraryUpload(orgId, libraryId) {
    const _response = await core.fetcher({
      url: (0, url_join_1.default)(
        ...
        `/orgs/${await serializers.OrgId.jsonOrThrow(
          orgId
        )}/library/${await serializers.LibraryId.jsonOrThrow(
          libraryId
        )}/get-upload-url`
      ),
      method: 'GET',
    ...
    if (_response.ok) {
      return await serializers.S3UrlForLibraryUploadResponse.parseOrThrow(
        _response.body,
        {
