      ...
      <Portal isOpen={isOpen}>
        <ModalContext.Provider value={{ onClose }}>
          ...
          >
            ...
            <div
              ref={modalRef}
              className={cn(getOrgName({ authInfo }) + '-modal', className)}
            >
              {children}
            </div>
          </div>
...
export function ModalHeader({
  ...
  return (
    <div
      ...
      ref={ref}
    >
      <div className={cn(getOrgName({ authInfo }) + '-modal-header-label')}>
        <span>{label}</span>
        {icon && (
          <FontAwesomeIcon
            icon={icon}
      ...
      <FontAwesomeIcon
        ...
        icon={faTimes}
        className={cn(getOrgName({ authInfo }) + '-modal-header-close-icon')}
      />
    </div>
  )
}
