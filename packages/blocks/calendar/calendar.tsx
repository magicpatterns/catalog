    ...
    >
      ...
      >
        {calendars.map((calendar, index) => (
          <div
            key={calendar.month}
            className={cn(getOrgName({ authInfo }) + '-calendar-container')}
          >
            <div
              key={calendar.month}
            ...
            <div className={cn(getOrgName({ authInfo }) + '-calendar-body')}>
  ...
  return (
    <>
      <div className={cn(getOrgName({ authInfo }) + '-calendar-table')}>
        <div className={cn(getOrgName({ authInfo }) + '-calendar-weekday-row')}>
...
function CalendarSelector({
  ...
  return (
    <button
      className={cn(getOrgName({ authInfo }) + '-calendar-header-icon-button')}
      {...(direction === 'left'
...
function CalendarCell({
  ...
  if (!dateObj) {
    return <div className={cn(getOrgName({ authInfo }) + '-calendar-cell')} />
  }
  ...
  return (
    <div
      className={cn(getOrgName({ authInfo }) + '-calendar-cell', {
        ...
        [getOrgName({ authInfo }) + '-calendar-cell-in-range']: isCellInRange,
