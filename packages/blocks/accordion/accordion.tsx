  ...
  return (
    <div
      className={cn(
        ...
        {
          [getOrgName({ authInfo }) + '-accordion-header-border']: hasBorder,
          [getOrgName({ authInfo }) + '-accordion-header-expanded']: isExpanded,
        },
        className
      )}
      onClick={() => {
    ...
    >
      <div
        className={cn(getOrgName({ authInfo }) + '-accordion-header-content')}
      >
        <span>{label}</span>
        {leftIcon && (
          <FontAwesomeIcon
...
export function AccordionBody({
  ...
  return (
    <div
      ref={internalRef}
      className={cn(getOrgName({ authInfo }) + '-accordion-body', className)}
      style={{
        ...style,
...
export function AccordionContent({
  ...
  return (
    <div
      className={cn(getOrgName({ authInfo }) + '-accordion-content', className)}
      style={style}
    >
      {children}
    </div>
...
export function AccordionFooter({
  ...
  return (
    <div
      className={cn(getOrgName({ authInfo }) + '-accordion-footer', className)}
      style={style}
    >
      <div
