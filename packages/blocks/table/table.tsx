...
export function TableHeaderCell({
  ...
  return (
    <th
      ...
      {...props}
    >
      <div className={cn(getOrgName({ authInfo }) + '-table-cell-content')}>
        {children}
        {sortIcon && (
          <FontAwesomeIcon
            icon={sortIcon}
...
function TableExpandableRowHeader({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div
      className={cn(getOrgName({ authInfo }) + '-table-expandable-row-header')}
    >
      <div
        className={cn(getOrgName({ authInfo }) + '-table-expandable-row-icon')}
        onClick={() => {
          if (setIsExpanded) {
...
function TableExpandableRowPanel({ children }: { children: React.ReactNode }) {
  ...
  return (
    ...
    >
      <div
        className={cn(getOrgName({ authInfo }) + '-table-expandable-row-panel')}
      >
        <div
          className={cn(
  ...
  return (
    ...
    >
      <div className={getOrgName({ authInfo }) + '-table-cell-content'}>
        {checkbox && (
          <div
            className={cn(getOrgName({ authInfo }) + '-table-cell-checkbox', {
              [getOrgName({ authInfo }) + '-table-cell-checkbox-separator']:
                separator,
            })}
          >
            <Checkbox />
        ...
        {leadingIcon && (
          <FontAwesomeIcon
            icon={leadingIcon}
            className={getOrgName({ authInfo }) + '-table-cell-leading-icon'}
          />
        )}
        {children}
        {trailingIcon && (
          <FontAwesomeIcon
            icon={trailingIcon}
            className={getOrgName({ authInfo }) + '-table-cell-trailing-icon'}
          />
        )}
      </div>
    </td>
