  ...
  return (
    ...
    >
      ...
      {isLoading && (
        <div
          className={cn([
            'mirrorful' + '-dataTable-footer-container',
            'mirrorful' + '-dataTable-footer-loading',
          ])}
        >
          <div
            className={'mirrorful' + '-dataTable-footer-loading'}
          >
            {renderLoading}
          </div>
        </div>
      ...
      {paginate && !isLoading && (
        <div
          className={cn([
            'mirrorful' + '-dataTable-footer-container',
            'mirrorful' + '-dataTable-footer-paginate',
          ])}
        >
          <div className={cn('mirrorful' + '-dataTable-paginate')}>
            <FontAwesomeIcon
              icon={faChevronLeft}
              className={'mirrorful' + '-dataTable-paginate-icon'}
              onClick={() => {
                if (pageNumber > 1) {
            ...
            <div
              className={
                'mirrorful' + '-dataTable-paginate-context'
              }
            >
