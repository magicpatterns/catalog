...
export function AriakitCombobox() {
...
export const ariakitComboboxData: TComponentData = {
  name: 'Combobox',
  library: 'ariakit',
  component: <AriakitCombobox />,
  tags: ['ariakit', 'combobox'],
  docsLink: 'https://ariakit.org/components/combobox',
}
